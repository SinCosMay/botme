...
function buildProfilePage(mode) {
  ...
  el.innerHTML = `
    <div class="page-header">
      ...
      <h1 class="page-title">${isSelfPage ? 'My Profile' : 'Search Profiles'}</h1>
      <p class="page-sub">${isSelfPage
        ? 'Sign in with your Discord ID once. This page will auto-load your profile next time.'
        : 'Search by Codeforces handle to view other users\' progress charts and stats.'}
      </p>
    </div>
  ...
  if (isSelfPage) {
    ...
    if (savedDiscordId) {
      ...
      setEmptyMessage('Sign in with your Discord ID to load your profile automatically.')
    }
